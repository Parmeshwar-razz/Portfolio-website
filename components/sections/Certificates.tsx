            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {certificates.map((cert) => (
                        <div
                            key={cert.id}
                            className="group relative bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-white/30 active:border-white/30 transition-all duration-300 hover:-translate-y-1 active:-translate-y-1"
                        >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300 flex items-end p-6">
                                    {cert.credential_url && (
                                        <a
                                            ...
                                            className="text-white flex items-center gap-2 hover:text-gray-300 active:text-gray-300 transition-colors"
                                        >
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 text-white transition-colors">{cert.title}</h3>
